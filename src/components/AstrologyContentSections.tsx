      ...
      <section className="max-w-5xl mx-auto px-4 mt-16">
        <div className="parchment rounded-2xl p-6 md:p-8 font-tamil">
          <h2 className="text-2xl md:text-3xl font-bold text-maroon-deep mb-3">
            AMMAN SOFTWARES — Free Tamil Astrology Software
          </h2>
          <p className="text-foreground/85 leading-relaxed mb-3">
            <b>AMMAN SOFTWARES</b> (also known as <b>AMMAN SOFTWARES</b> or <b>ammansoftwares</b>) is a free, browser-based Tamil astrology software. It is the modern web edition of the popular tool published at{" "}
          ...
          <p className="text-foreground/85 leading-relaxed">
            Use AMMAN SOFTWARES online to generate full Tamil jathagam with rasi & navamsa kattam, 27 nakshatra, lagna, Vimsottari dasha-bhukti, panchangam (tithi, yoga, karana, nalikai), thirumana porutham (10 matching), Chevvai / Rahu-Kethu dosha analysis, and a one-page A4 printable PDF — all in Tamil &amp; English.
          </p>
      ...
      <section className="max-w-4xl mx-auto px-4 mt-10">
        <div className="parchment rounded-2xl p-6 md:p-8 font-tamil">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="font-bold text-maroon-deep">AMMAN SOFTWARES பயன்படுத்த கட்டணம் உண்டா?</h3>
