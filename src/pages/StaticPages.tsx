...
export const About = () => (
  <Shell
    title="எங்களை பற்றி | About AMMAN SOFTWARES"
    description="AMMAN SOFTWARES — இலவச தமிழ் வேத ஜோதிட இணையதளம். எங்களின் நோக்கம், கணிப்பு முறை மற்றும் சேவைகள் பற்றிய தகவல்."
    canonical="https://kanagadara.lovable.app/about"
  >
    <h1 className="text-3xl font-bold text-maroon-deep mb-4">எங்களை பற்றி</h1>
    <p className="mb-4">
      AMMAN SOFTWARES என்பது தமிழ் மக்களுக்காக உருவாக்கப்பட்ட இலவச வேத ஜோதிட இணையதளம். எங்களின் நோக்கம் — பாரம்பரிய ஜோதிட அறிவை எளிய தமிழில், எவரும் புரிந்து கொள்ளக்கூடிய வகையில், எந்த கட்டணமும் இல்லாமல் வழங்குவதாகும்.
    </p>
    ...
    <p>
      ஜோதிடம் என்பது வழிகாட்டி — விதியின் கட்டளை அல்ல. தனிப்பட்ட சவால்களை அறிந்து தயாராக இருக்கவும், சாதகமான காலங்களில் முக்கிய முடிவுகள் எடுக்கவும் இது உதவும் ஒரு கருவி. AMMAN SOFTWARES இதை மக்களுக்கு அன்பளிப்பாக வழங்குகிறது.
    </p>
  </Shell>
);
...
export const Contact = () => (
  <Shell
    title="தொடர்பு | Contact AMMAN SOFTWARES"
    description="AMMAN SOFTWARES — ஜோதிட ஆலோசனை, கருத்து, தொழில்நுட்ப ஆதரவுக்கு எங்களை தொடர்பு கொள்ள."
...
export const PrivacyPolicy = () => (
  <Shell
    ...
    description="AMMAN SOFTWARES தனியுரிமை கொள்கை — தரவு சேகரிப்பு, பயன்பாடு, குக்கீ, மூன்றாம் தரப்பு சேவைகள் பற்றிய விளக்கம்."
...
export const Terms = () => (
  <Shell
    ...
    description="AMMAN SOFTWARES பயன்பாட்டு நிபந்தனைகள் — சேவை விதிமுறைகள், பொறுப்புத்துறப்பு மற்றும் பயனர் கடமைகள்."
  ...
  >
    ...
    <p className="mb-3">
      AMMAN SOFTWARES இலவச ஜோதிட கணிப்பு கருவிகள் மற்றும் கல்வி தொடர்பான கட்டுரைகளை வழங்குகிறது. இந்த தளத்தை பயன்படுத்துவதன் மூலம் இங்குள்ள நிபந்தனைகளை நீங்கள் ஏற்றுக்கொள்கிறீர்கள்.
    </p>
    ...
    <p className="mb-3">
      இந்த தளத்தின் அனைத்து உள்ளடக்கம், வடிவமைப்பு, லோகோ — AMMAN SOFTWARES-க்கு சொந்தமானது. தனிப்பட்ட பயன்பாட்டிற்கு மட்டுமே அனுமதிக்கப்படுகிறது.
    </p>

    <h2 className="text-xl font-bold text-maroon-deep mt-4 mb-2">5. பொறுப்பு வரம்பு</h2>
    <p>
      ஜோதிட பலன்களின் அடிப்படையில் எடுக்கும் முடிவுகளுக்கு AMMAN SOFTWARES பொறுப்பல்ல. தளம் "as is" அடிப்படையில் வழங்கப்படுகிறது.
    </p>
  </Shell>
);
...
export const Disclaimer = () => (
  <Shell
    ...
    description="AMMAN SOFTWARES — ஜோதிட பலன்கள் கல்வி நோக்கம் மட்டுமே என்ற பொறுப்புத்துறப்பு."
  ...
  >
    ...
    <p className="mb-4">
      AMMAN SOFTWARES வழங்கும் அனைத்து ஜோதிட கணிப்புகள், கட்டுரைகள் மற்றும் பலன்கள் — <strong>கல்வி, தகவல் மற்றும் கலாச்சார நோக்கங்களுக்காக மட்டுமே</strong>. இதை ஒரு வழிகாட்டியாக கருதவேண்டுமே தவிர, விதியின் இறுதி தீர்ப்பாக அல்ல.
    </p>
    ...
    <p>
      உங்கள் வாழ்க்கை முடிவுகள் முழுமையாக உங்களுடையதே. AMMAN SOFTWARES வழங்கும் தகவல்களின் அடிப்படையில் எடுக்கும் எந்த நடவடிக்கைக்கும் தளம் பொறுப்பேற்காது.
    </p>
  </Shell>
);
